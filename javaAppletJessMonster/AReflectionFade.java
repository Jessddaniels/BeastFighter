...
public class AReflectionFade extends Attack {
	...
	public void attack( Leader defender) {
		mon.setDamage(mon.getDamage() + 30);
	...
	public void paint(Graphics g, int x, int y, JessMonster applet) {
		...
		g.drawImage(applet.getImage(Images.Damage), x + 115 ,y + 20, applet);
		g.drawImage(applet.getImage(Images.Experience), x + 115 ,y + 30, applet);
