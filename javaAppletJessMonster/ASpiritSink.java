...
public class ASpiritSink extends Attack {
	...
	public void paint(Graphics g, int x, int y, JessMonster applet) {
		g.drawImage(applet.getImage(mon.getURL(),"SpiritSink.jpg"), x,y, applet);
		x = x + 5;
		g.setFont(nameFont);
		...
		g.drawImage(applet.getImage(mon.getURL(),"Energy.jpg"), x + 22,y + 18, applet);
		g.drawImage(applet.getImage(mon.getURL(),"Spirit.jpg"), x + 57,y + 18, applet);
	}
}
