...
public class ABodySlam extends Attack {
	...
	public void paint(Graphics g, int x, int y, JessMonster applet) {
		g.drawImage(applet.getImage(mon.getURL(),"BodySlam.jpg"), x,y, applet);
		g.drawImage(applet.getImage(mon.getURL(),"Energy.jpg"), x + 105,y + 15, applet);
		g.drawImage(applet.getImage(mon.getURL(),"Health.jpg"), x + 135,y + 45, applet);
		x = x + 5;
		g.setFont(nameFont);
